...
That's enough dating for today folks...yous have got wifes and husbands to go home to!

But, just as a healthy relationship promotes personal growth, so shall I show you how you can use R and Git to grow as an analyst in a healthy, norishing, polyamorous relationship. 
...
And then, I will show how you can ensure your analytical work is auditable, xplanable, and reproducible with the version control software `Git`. 

???

Imagine this - EES is released and writing publications is now a dodle. Now that time has been saved there, you've got a bit more time to automate and enhance the other work you do. 
...
We've had enough black and white so far folks. But now we need to give this painting a bit 'o colour...
...
Same with Git. It's boon really starts blooming when you use it to work collabotativly. 
...
Whereas Git is like a vaccine: after the initial wince of getting it, you garner a variety of long-term benfits like:

 1. Creating a clear, auditable trail of how you created your code for QA, and for your own record;
 2. Improving knowledge management by documentating why you made changes in the commit messages; and,
 3. Preventing cluttered and confusing folders by using branches to keep files with different contents and features seperate.
...
.footnote[
To read both resources, click on the link containing the word 'download' at the bottom of each pages, save the files, and then open the html files in your favourite browser (which **should not be** Internet Explorer). 
]
